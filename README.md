...
| [**qgemv‑roofline**](https://github.com/manunicholasjacob/qgemv-roofline) | A quantized GEMV kernel ladder measured against its own bandwidth roof: 12 CUDA kernels plus Triton for batch-1 LLM decode over ggml `q8_0`/`q4_0`, across five NVIDIA GPUs from sm_60 to sm_89. |
